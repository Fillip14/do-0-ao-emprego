...
Etapa 2 · Back-end: da API ao deploy  ████░░░░░░░░░░░░░░░░░░   20%  🔨 T2 de 10 concluído
...
| **T3** | TypeScript — strict, narrowing, generics, utility types | ⏳ |
...
| 22/07 | **T2 — Express (Ex 12–13)** — erro em handler `async` e a diferença entre Express 4 e 5 · `app` separado do `server` + suíte com **supertest**. Fechou com um bug achado por raciocínio, não por teste: `POST` sem `Content-Type` derrubava o handler em 500 — corrigido e travado com teste de regressão |
