...
export const ItemTask = ({ task, onChangeTask, onDeleteTask }: ItemTaskProps) => {
  return (
    <li className="relative flex justify-between items-center bg-amber-100 rounded-lg p-2">
      ...
      <div className="flex flex-col gap-1 items-center">
        ...
        <Button
          aria-label={`Alterar status de ${task.description}`}
      ...
      <div className="absolute top-0 right-0">
        <Button
          aria-label={`Excluir task de ${task.description}`}
